...
class QLearnTrainNode(Node):
    def __init__(self):
        ...
        self.q_table_file = os.path.join(self.qtable_dir, 'qlearn3_qtable.npy')
        ...
        self.reward_file = os.path.join(self.reward_dir, 'qlearn3_rewards.csv')
